...
$sidebar_class        = ( is_active_sidebar( 'sidebar-1' ) && get_theme_mod( 'artsy_single_post_sidebar_toggle', 1 ) == 1 ) ? $sidebar_class = 'has-sidebar' : $sidebar_class = '';
...
$col_class            = ( is_active_sidebar( 'sidebar-1' ) && get_theme_mod( 'artsy_blog_sidebar_toggle', 1 ) == 1 ) ? $col_class = 'col-lg-6 col-md-6 col-sm-6' : $col_class = 'col-lg-4 col-md-6 col-sm-6';
?>
<div id="content" class="<?php echo esc_attr( $sidebar_class ); ?>">
	<div class="container">
		<div class="row">
			<main id="main" class="<?php echo esc_attr( $outer_col_class ); ?>">
				<h1 class="blog-title"><?php echo esc_attr( $our_title  ); ?></h1>
				<div class="row masonry-grid">
					<?php while ( have_posts() ) : the_post(); ?>
						<div class="<?php echo esc_attr( $col_class ); ?>">
							<article
									id="post-<?php the_ID(); ?>" <?php post_class( 'post-item post-grid-item' . $no_excerpt_class ); ?>>
								<?php if ( has_post_thumbnail() ) : ?>
									<div class="post-thumbnail">
										<a href="<?php the_permalink(); ?>">
											<?php the_post_thumbnail( 'artsy-medium-image' ); ?>
										</a>
									</div>
								<?php endif; ?>
